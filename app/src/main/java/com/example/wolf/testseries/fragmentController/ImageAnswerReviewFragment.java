 ...
 */
public class ImageAnswerReviewFragment extends Fragment {
    ...
    public static ImageAnswerReviewFragment newInstance(int questionNumber, int testId, int optionSelected) {
        ImageAnswerReviewFragment fragment = new ImageAnswerReviewFragment();
    ...
    public ImageAnswerReviewFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.image_answer_review, container, false);
        initialize();
